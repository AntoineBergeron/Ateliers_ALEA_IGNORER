...
```
                                  |--- Tant que le nombre d'orange de la caisse 1 est plus
WHILE NbOrange_1 > 0 <------------|--- grand que 0
  NbOrange_1 <- NbOrange_1 - 1 <------ On enlève une orange de la caisse 1
  NbOrange_2 <- NbOrange_2 + 1 <------ On ajoute une orange dans la caisse 2
END WHILE  <----------------------|--- Se termine seulement quand le nombre d'orange de la
                                  |--- caisse 1 sera plus petit ou égal à 0 (soit 0)
```
---
