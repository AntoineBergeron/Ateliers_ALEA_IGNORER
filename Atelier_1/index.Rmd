...
- Exprimer le résultat d'un tableau.
...
Dans Excel:
- Afin de calculer le nombre moyen de buts marqué en fonction des différents résultats d'une partie sur Excel, nous devons calculer (en exemple, pour les défaites): `Somme` de `Nombre de buts marqué * Nombre de défaites par ce nombre de buts`

Puis diviser cette somme par le nombre total de défaites.
