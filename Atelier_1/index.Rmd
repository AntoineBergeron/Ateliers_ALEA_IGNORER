...
Le fichier [ExerciceRecapitulatif.csv](./donnees/ExerciceRecapitulatif.csv) est un sommaire de données sur le virus qui frappe présentement la planète Erret: Le Divoc-91!
