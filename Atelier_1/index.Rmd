...
Bruno et Martin s'entraîne au lancer du poids. Au cours des dernières années, Bruno et Martin ont dû s'affronter 10 fois dans des compétitions. Pour Bruno, son meilleur lancer (en mètres) pour chacune des compétitions est donné par le vecteur B. Les meilleurs lancers de Martin se retrouve dans le vecteur M.
...
Ainsi, pour accéder au résultat de Bruno lors de sa deuxième compétition, il suffit de 
...
5. Enregistrer les résultats dans un tableau où les étiquettes de rangées correspondent aux nombres de jours passés à l'hôpital (la dernière ligne correspondra au frais totaux par région) et les étiquettes des colonnes correspondent aux régions. Le tableau final doit avoir la forme de l'image ci-dessous.

<div style='text-align:center;'>
<img src="assets/img/ExempleRecap.PNG" width="40%"></img>
