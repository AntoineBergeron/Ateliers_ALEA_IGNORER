...
Bruno et Martin s'entraîne au lancer du poids. Au cours des dernières années, ils ont dû s'affronter 10 fois dans des compétitions. Pour Bruno, son meilleur lancer (en mètres) pour chacune des compétitions est donné par le vecteur B. Les meilleurs lancers de Martin se retrouve dans le vecteur M.
...
# Solution de l'exercice 2 (tentative 1)
...
---
# Solution de l'exercice 2 (tentative 2)
