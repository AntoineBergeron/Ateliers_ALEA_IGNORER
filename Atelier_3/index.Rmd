...
Les données (en millions d'habitant) ressemblent à ce qui suit:
...
Imaginez cependant qu'on vous demande d'effectuer une étude similaire sur l'ensemble de tout les pays dans le monde, sur une période de 50 ans. Le nombre de calcul à effectuer deviendrait alors beaucoup trop élevé pour être effectué à la main. Il faudra alors changer de technique....
