...
# Exercice: Abondances relatives (en nourriture et boisson aussi!)
...
2. Calculer en fonction des sacs de chips le nombre moyen d'enfant par type de liqueur. 
3. Calculer le coefficient de variation. (Écart-type/Moyenne avec sd() et mean())
4. Calculer le nombre total d'enfants ayant mangé chaque sorte de chips.
5. Transformer les valeurs du tableau afin d'obtenir le pourcentage d'enfants ayant mangé chaque sorte de chips.
