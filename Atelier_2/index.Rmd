...
Dans cette exercice récapitulatif, nous travaillerons à partir de deux fichiers (deux jeux de données).

[soccer.csv](./donnees/soccer.csv) : Statistiques de 50 joueurs de soccer professionnels.

[minjoue.csv](./donnees/minjoue.csv) : Statistiques sur le temps de jeu des 50 joueurs sur 20 parties.

Pour cet exercice, nous nous intéresserons à déterminer la valeur actuelle d'un joueur de soccer.
