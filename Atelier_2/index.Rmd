...
<div style='text-align:center;'>
<img src="assets/img/exercice2.PNG" height="600"></img>
</div>
...
```{r}
montant_total <- function(nbOr,prixOran,borneOran,pourcOran,nbPo,prixPomm,bornePomm,pourcPomm,nbPa,prixPamp,bornePamp,pourcPamp){  #nbOr, nbPo et nbPa sont respectivement le nombre de caisses d'oranges, de pommes et de pamplemousses.
  #prixOran, prixPomm et prixPamp sont respectivement le prix des caisses d'oranges, de pommes et de pamplemousses.
  #borneOran, bornePomm et bornePamp sont respectivement le nombre de caisses pour chaque fruit avant d'obtenir une bonification.
  #pourcOran, pourcPomm et pourcPamp sont respectivement le pourcentage supplémentaire à partir de la borne.
  if(nbOr > borneOran){
