...
On arriverait simplement à calculer le montant total d'Alexis.

---

# Solution de l'exercice 2: (suite)

Suffit alors de changer le nombre de caisses pour chaque type de fruit ainsi que les trois éléments surlignés en cyan.
